 ...
 * @author Xiaotian Le
 */
public class StanfordLemmaHandler extends edu.illinois.cs.cogcomp.annotation.Annotator {

    public static final String VIEW_NAME = ViewNames.LEMMA;
    public static final Class<? extends CoreAnnotation<String>> STANFORD_CLASS_NAME = CoreAnnotations.LemmaAnnotation.class;

    private Annotator annotator;

    public StanfordLemmaHandler() {
        this(true);
    }

    public StanfordLemmaHandler(boolean isLazilyInitialized) {
        super(VIEW_NAME, new String[]{ViewNames.SENTENCE, ViewNames.POS}, isLazilyInitialized);
    }

    @Override
    public void initialize(ResourceManager rm) {
        annotator = StanfordAnnotationUtil.getDefaultAnnotator(new Properties(), Annotator.STANFORD_LEMMA);
    }
