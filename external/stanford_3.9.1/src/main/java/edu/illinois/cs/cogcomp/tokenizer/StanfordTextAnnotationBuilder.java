 ...
 * @author Xiaotian Le
 */
public class StanfordTextAnnotationBuilder implements TextAnnotationBuilder {

    private StanfordCoreNLP pipeline;

    public StanfordTextAnnotationBuilder() {
    ...
    public TextAnnotation createTextAnnotation(
        ...
        throw new IllegalArgumentException(
                "Cannot create annotation from Tokenization using StanfordTextAnnotationBuilder");
    }
}
