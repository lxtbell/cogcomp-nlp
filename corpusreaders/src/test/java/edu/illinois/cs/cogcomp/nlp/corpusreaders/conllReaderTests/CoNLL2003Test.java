...
public class CoNLL2003Test {
    ...
    public void testCreateTextAnnotation() throws Exception {
        AnnotationReader<TextAnnotation> cnr = new CoNLL2003Reader(CoNLL2003Reader.Tagset.CONLL, CORPUS_DIRECTORY);
        ...
        ColumnFormatGenericWriter writer = new CoNLL2003Writer(CoNLL2003Reader.Tagset.CONLL);
