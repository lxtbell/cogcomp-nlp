...
import edu.illinois.cs.cogcomp.nlp.corpusreaders.conllReader.ritter.RitterChunkDataWriter;
import edu.illinois.cs.cogcomp.nlp.corpusreaders.conllReader.ritter.RitterNERDataWriter;
import edu.illinois.cs.cogcomp.nlp.corpusreaders.conllReader.ritter.RitterPOSDataWriter;
...
public class RitterCorpusTest {
    ...
    public void testPOSDataReader() throws Exception {
        AnnotationReader<TextAnnotation> reader = new RitterPOSDataReader(CORPUS_DIRECTORY);
        ...
        ColumnFormatGenericWriter writer = new RitterPOSDataWriter();
    ...
    public void testChunkDataReader() throws Exception {
        AnnotationReader<TextAnnotation> reader = new RitterChunkDataReader(CORPUS_DIRECTORY);
        ...
        File tempFile = File.createTempFile(RitterCorpusTest.class.getSimpleName() + "-", ".txt");
        tempFile.deleteOnExit();
        ColumnFormatGenericWriter writer = new RitterChunkDataWriter();
        writer.write(ta, tempFile.toString());
    ...
    public void testNERDataReader() throws Exception {
        AnnotationReader<TextAnnotation> reader = new RitterNERDataReader(RitterNERDataReader.Tagset.CONLL_RAW, CORPUS_DIRECTORY);
        ...
        File tempFile = File.createTempFile(RitterCorpusTest.class.getSimpleName() + "-", ".txt");
        tempFile.deleteOnExit();
        ColumnFormatGenericWriter writer = new RitterNERDataWriter(RitterNERDataReader.Tagset.CONLL_RAW);
        writer.write(ta, tempFile.toString());
